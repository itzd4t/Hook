...
_G.Color = Color3.fromRGB(123, 168, 25) -- สี Gui
_G.imageLogo = "rbxassetid://" -- Logo Gui
-----------------------------------------------------------------
...
function library:Evil()
	...
	Desc.Text = "Scripts Rewrite V.1 ━  [🐆 🍩] Blox Fruits"
...
local Tab = Window:Tab("Genaral","7072717697")
local Tab2 = Window:Tab("Players","7072724538")
local Tab3 = Window:Tab("Shop/Fruits","7072715646")
local Tab4 = Window:Tab("Island","6035190846")
local Tab5 = Window:Tab("Dungeon","7044284832")
local Tab6 = Window:Tab("Misc","7044233235")
--สัส

local Section = Tab:Section("[ AuToFarm ]","Left")
local Section2 = Tab:Section("[ Setting AuToFarm ]","Right")
local Section4 = Tab:Section("[ Othor]","Left")
...
Section:Toggle("AuTo Fruits Mas (NotFully) 🔧",false,function(a)
    _G.AuToFarmMasFruits = a
end)

Section:Slider("HP MON",1,1000,25,function(value)
    _G.KillAt = value
end)
...
if game.PlaceId == 2753915549 then
    ...
    Section4:Toggle("AuTo NewWorld (NotFully)🔧",false,function(value)
        _G.Sea2 = value
    end)

    
    Section4:Toggle("Auto Saber",_G.Auto_Saber,function(value)
        _G.Auto_Saber = value
    end)   

    Section4:Toggle("Auto Saber Hop",_G.Auto_Saber_Hop,function(value)
	...
	Section4:Toggle("AuTo ThirdWorld (NotFully) 🔧",_G.Auto_Saber_Hop,function(value)
		_G.Auto_Third_World  = value
	end)


	Section4:Toggle("Auto Rengoku",_G.Auto_Rengoku,function(value)
		...
		Section4:Toggle("🦴 Auto Farm Bone 🦴",_G.Auto_Farm_Bone,function(value)
			_G.Auto_Farm_Bone = value
		end)
	
		Section4:Toggle("📩 Auto Random Bone 📩",_G.Auto_Random_Bone,function(value)
		...
		Section4:Toggle("🎂 Auto Cake Prince 🎂",_G.Auto_Cake_Prince,function(value)
		...
		Section5:Button("Check Elite Hunter",function(v)
			game.StarterGui:SetCore("SendNotification", {
				...
				Text = "━━━━━━━━━━",
				Icon = "http://www.roblox.com/asset/?id=11389534455",
				Duration = 2.5
			})
		end)
...
local Up2 = Tab2:Section("[ Lock Data ]","Right")
...
Up1:Toggle("☑️ Stats Kaitun ☑️",false,function(v)
...
Up2:Slider("Amount Level",1,2400,700,function(value)
    _G.Point_Level = value
end)

Up2:Toggle("Lock Level",false,function(v)
	_G.Lock_Level = v 
end)
...
spawn(function()
	pcall(function()
		while wait()do
			if _G.Lock_Level then
				if game:GetService("Players").LocalPlayer.Data.Level.Value >= _G.Point_Level then
...
Up2:Slider("Amount Bili",1,100000000,700,function(value)
    _G.Point_Bile = value
end)

Up2:Toggle("Lock Beli",false,function(v)
	_G.Lock_Bile = v 
end)
...
spawn(function()
	pcall(function()
		while wait()do
			if _G.Lock_Bile then
				if game.Players.LocalPlayer.Data.Beli.Value >= _G.Point_Bile then
					game.Players.LocalPlayer:Kick("Lock Bile Kick")
					wait()
					local ts = game:GetService("TeleportService")
					local p = game:GetService("Players").LocalPlayer
					ts:Teleport(game.PlaceId, p)
...
------------------------------------------------------------------------------------------
local Shop1 = Tab3:Section("[ Buy Melee ]","Left")
local Shop2 = Tab3:Section("[ DevilFruits] ","Right")
local Shop3 = Tab3:Section("[ Buy Ability ]","Right")
local Shop4 = Tab3:Section("[ Buy Sword ]","Left")
local Shop5 = Tab3:Section("[ Buy Gun ]","Right")
...
-----------------------------
Shop2:Toggle("Auto Random Fruit",false,function(v)
...
Shop2:Toggle("Auto Bring Fruit",false,function(v)
...
Shop2:Toggle("Auto Store Fruit",false,function(v)
...
Tp1:Button("Sea 3 World",function()
    local args = {
        [1] = "TravelZou"
    }
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Raid1:Toggle("Auto Farm Dungeon",false,function(a)
	_G.Auto_Next_Island = a
end)

local Raid2 = Tab5:Section("!!(Đôi lúc sẽ bug)!!","Right")

Raid2:Toggle("Kill Aura",false,function(a)
	_G.Kill_Aura = a
end)
...
-------------------------------------------------------------------------
local Join = Tab6:Section("[ Join Team ]","left")
local Join2 = Tab6:Section("[ Server All ]","left")
local Join3 = Tab6:Section("[ Open Gui All ]","left")
local Join4 = Tab6:Section("[ Fake Data ]","Right")
local Join5 = Tab6:Section("[ Setting Players ]","left")
...
Join4:Textbox("Fake Level","Amount Level ?",function(value)
	game:GetService("Players")["LocalPlayer"].Data.Level.Value = value
end)

Join4:Textbox("Fake beli","Amount Bili ?",function(value)
	game:GetService("Players")["LocalPlayer"].Data.Beli.Value = value
end)

Join4:Textbox("Fake Fragments","Amount Fragments ?",function(value)
	game:GetService("Players")["LocalPlayer"].Data.Fragments.Value = value
end)

Join4:Textbox("Fake Points","Amount Points ?",function(value)
	game:GetService("Players")["LocalPlayer"].Data.Points.Value = value
end)

Join4:Textbox("Fake Exp","Amount Exp ?",function(value)
...
Join4:Button("Fake Level Up",function(v)
	if game.Players.LocalPlayer.Data.Level.Value == 1 or game.Players.LocalPlayer.Data.Level.Value <= 2400 then
	...
	delay = 0
	count = 0
	while plr.Data.Exp.Value - EXPFunction(Data.Level.Value) > 0 do wait()
...
spawn(function()
    while wait() do
        if _G.AUTOFARM or _G.AutoFarmBone or _G.Auto_Rengoku or _G.Auto_Farm_Boss or _G.Auto_Farm_Bone or _G.Auto_Elite_Hunter or _G.Auto_Cake_Prince then
            pcall(function()
...
Section2:Toggle("FastAttack",false,function(a)
    _G.FastAttack = a
end)
...
Section2:Toggle("Bypass Farm",true,function(a)
    _G.By_Pass = a
end)

Section2:Toggle("AuTo Set Spawn",true,function(a)
    _G.SetSpawn = a
end)
...
spawn(function()
while task.wait() do
	if _G.AUTOFARM or _G.Auto_Cake_Prince or _G.Auto_Elite_Hunter or _G.Auto_Farm_Bone  or _G.AutoFarmBone or _G.AuToFarmMasFruits or _G.Sea2 or _G.Auto_Rengoku or _G.Auto_Next_Island or _G.Auto_Farm_Boss or _G.Auto_Saber then
    pcall(function()
        CamShake:Stop()
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.AUTOFARM or _G.Auto_Cake_Prince or _G.Auto_Elite_Hunter or _G.Auto_Farm_Bone or _G.Auto_Farm_All_Boss or _G.AutoFarmBone or _G.Auto_Third_World or _G.AuToFarmMasFruits or _G.Sea2 or _G.Start_Tween_Island or _G.Auto_Rengoku or _G.Auto_Next_Island or _G.Auto_Farm_Boss or _G.Auto_Saber or _G.Auto_Fully_SharkMan_Karate then
                if not game:GetService("Players").LocalPlayer.Character.HumanoidRootPart:FindFirstChild("BodyClip") then
                    local Noclip = Instance.new("BodyVelocity")
                    Noclip.Name = "BodyClip"
                    Noclip.Parent = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart
...
spawn(function()
    pcall(function()
        game:GetService("RunService").Stepped:Connect(function()
            if _G.AUTOFARM or _G.Auto_Cake_Prince or _G.Auto_Elite_Hunter or _G.Auto_Farm_Bone  or _G.Auto_Farm_All_Boss or _G.AutoFarmBone or _G.AuToFarmMasFruits or _G.Sea2 or _G.Start_Tween_Island or _G.Auto_Rengoku or _G.NoClip or _G.Auto_Farm_Boss or _G.Auto_Saber then
...
spawn(function()
	pcall(function()
		while wait() do
			if _G.AUTOFARM or _G.Auto_Cake_Prince or _G.Auto_Elite_Hunter or _G.Auto_Farm_Bone  or _G.AutoFarmBone or _G.AuToFarmMasFruits or _G.Sea2 or _G.Auto_Rengoku or _G.Auto_Farm_Boss or _G.Auto_Saber then
